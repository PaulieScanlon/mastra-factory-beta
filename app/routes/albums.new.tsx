            ...
            {palettes.map((p, i) => {
              return (
                <label key={p} className="cursor-pointer">
                  ...
                  />
                  <div
                    className={`cover palette-${p} aspect-square rounded-lg border-2 border-transparent peer-checked:border-white transition peer-focus-visible:ring-2 peer-focus-visible:ring-white/70`}
                  />
